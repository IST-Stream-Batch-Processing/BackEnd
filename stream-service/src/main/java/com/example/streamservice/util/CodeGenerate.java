package com.example.streamservice.util;
...
public class CodeGenerate {
    private static final String WRITER_PATH = "./src/main/java/com/example/streamservice/pojo/";
    public void javac(String dataName){
        ...
        Iterable<String> options = Arrays.asList("-d", System.getProperty("user.dir")+"/src/main/java/com/example/streamservice/classes");
        //编译任务,可以编译多个文件
